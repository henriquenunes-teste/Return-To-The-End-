...
\restrict OSWPNjfAfYYTwNmnbc4A62Bwvq1H9ihk4RiVCUTEi933pRb7XgtsD8vbY4gU1Xw

-- Dumped from database version 16.13 (Ubuntu 16.13-0ubuntu0.24.04.1)
-- Dumped by pg_dump version 16.13 (Ubuntu 16.13-0ubuntu0.24.04.1)

-- Started on 2026-06-29 18:33:40 -04
...
COPY public.upgrade (id, strength, health, recup, player_id) FROM stdin;
1	1	0	0	2
\.
...
SELECT pg_catalog.setval('public.run_id_seq', 9, true);
...
--
-- TOC entry 3364 (class 2606 OID 49830)
-- Name: upgrade upgrade_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.upgrade
    ADD CONSTRAINT upgrade_fk FOREIGN KEY (player_id) REFERENCES public.players(id) NOT VALID;
...
-- Completed on 2026-06-29 18:33:40 -04

--
-- PostgreSQL database dump complete
--

\unrestrict OSWPNjfAfYYTwNmnbc4A62Bwvq1H9ihk4RiVCUTEi933pRb7XgtsD8vbY4gU1Xw
